...
public class ContactEntity implements BaseColumns {
	 ...
	 * @param jsonObj
	 */
	public ContactEntity(JSONObject jsonObj){
		try {
	...
	public JSONObject toJSONObject(){
		...
		try {
			...
			jsonObj.put("partytype", partytype);
			jsonObj.put("companyid", companyid);
			jsonObj.put("companyname", companyname);
			jsonObj.put("partyface", partyface);
			jsonObj.put("title", title);
			jsonObj.put("background", background);
...
//		initialValues.put(KEY_SORT_KEY, sortKey);
//		initialValues.put(KEY_PARTYID, partyId);
//		initialValues.put(ContactEntity._ID, partyId);//partyId作为主键
//		return initialValues;
//	}
}
