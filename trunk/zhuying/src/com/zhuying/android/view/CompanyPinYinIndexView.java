 ...
 * 拼音索引条
 */
public class CompanyPinYinIndexView extends View {
	private int width;
	private int height;
	...
	private CompanyCursorAdapter listAdapter;
	...
	public CompanyCursorAdapter getListAdapter() {
		return listAdapter;
	}

	public void setListAdapter(CompanyCursorAdapter listAdapter) {
		this.listAdapter = listAdapter;
	}

	public CompanyPinYinIndexView(Context context) {
		this(context, null);
	}
	 ...
	 * @param attrs
	 */
	public CompanyPinYinIndexView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public boolean onTouchEvent(MotionEvent event) {
		if (event.getAction() == MotionEvent.ACTION_DOWN
			...
			if (tempY < alphabetArray.length) {
				listAdapter = (CompanyCursorAdapter) getListAdapter();
				...
				if (sectionAry != null) {
					...
					if (event.getY() > 0
						...
						getListView().setSelection(listAdapter
								.getPositionForSection(listViewIndexList
										.indexOf(alphabetArray[tempY])));
					}
